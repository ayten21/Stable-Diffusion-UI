...
- 'git clone' this repository into your device
Open your terminal and write:
- cd stable-diffusion-ui
- python3 launch.py

If you are facing with errors running above code, try this instead:
- python3 launch.py --disable-safe-unpickle --share --medvram
